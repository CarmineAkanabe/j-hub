        ...
        <div class="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-slate-600">Update your admin account details and password.</p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('admin.profile.update') }}" class="mt-8 space-y-6">
                @csrf
                @method('PATCH')
