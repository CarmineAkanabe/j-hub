...
$buttonClasses = trim("inline-flex items-center justify-center rounded-full px-4 py-2 text-sm font-medium transition focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 {$variants[$variant] ?? $variants['primary']} {$class}");
@endphp
